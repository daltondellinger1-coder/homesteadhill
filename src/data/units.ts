...
export const units: Unit[] = [
  ...
  },
  {
    ...
    bedType: "King",
    baths: 1,
    description: "Standalone king-bed cottage with a stylish living area, kitchenette, modern bath, Wi-Fi, TV, A/C & heat, smart-lock self check-in, and free parking.",
    amenities: ["Standalone Cottage", "King Bed", "Stylish Living Area", "Kitchenette", "Modern Bath", "Wi-Fi", "TV", "A/C & Heat", "Smart Lock", "Free Parking"],
    featured: true,
    monthlyPrice: 1650,
  },
  {
